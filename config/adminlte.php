...
return [
    ...
    */
    ...
    'title' => '',
    'title_prefix' => '',
    'title_postfix' => ' | Control Refrigeracion',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text'       => 'Laboratorio de Cafe',
                    'icon_color' => 'green',
                    'route'    => 'cafe'
                ],
                [
                    'text'       => 'Laboratorio de Quimica',
                    'icon_color' => 'white',
                    'route'    => 'quimica',
                ],
                [
                    'text'       => 'Laboratorios de Microorganismos',
                    'icon_color' => 'red',
                    'route'    => 'micro'
                ],
                [
                    'text'       => 'Restaurante de los Aprendices',
                    'icon_color' => 'purple',
                    'route'    => 'restaurante'
                ],
                [
                ...
                [
                    'text'       => 'Taller de Panificacion ',
                    'icon_color' => 'cyan',
                    'route'    => 'pani'
                ],
               
                [
                    'text'       => 'Taller de  Produccion',
                    'icon_color' => 'red',
                    'route'    => 'produccion'
                ],
            ],
